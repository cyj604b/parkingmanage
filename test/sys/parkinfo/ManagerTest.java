...
public class ManagerTest {
    ...
    public void testCarIn()
    {
        ...
        assertEquals(aimPark.getParkNumber(), "P007");
    ...
    public void testCarIn2()
    {
        ...
        assertEquals(aimPark.getParkNumber(), "P006");
        boolean tag = aimPark.addCar(car1);
        assertEquals(tag, true);
    }
    /**
    ...
    public void testCarOut1()
    {
        ParkMagService parkMagService=new ParkMagService();
        //取车
        boolean tag = parkMagService.pickUpCar(manager1.getParks(),new Car("京 A0001"));
    ...
    public void testCarOut2()
    {
        ParkMagService parkMagService=new ParkMagService();
        //取车
        boolean tag=parkMagService.pickUpCar(manager1.getParks(),new Car("京 G0001"));
        assertEquals(tag, true);
    }
    /**
     * 打印停车场信息
